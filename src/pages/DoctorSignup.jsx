...
import { Mail, User, Phone, Calendar, Lock, AlertCircle, Loader2, Stethoscope } from "lucide-react";
...
const DoctorSignup = () => {
  const [formData, setFormData] = useState({
    ...
    confirm_password: "",
    license_number: "",
    certificate: null, // New field for certificate file
    role: "doctor",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await register(formDataToSend); // Assuming register can handle FormData
      navigate("/login");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      ...
      >
        <h1 className="text-2xl font-bold mb-4 text-center text-blue-700 dark:text-blue-400">Doctor Sign Up</h1>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="flex items-center text-xs font-medium mb-1 text-gray-700 dark:text-gray-300">
              <Stethoscope className="mr-1" size={14} /> Medical License Number
            </label>
            <input
              type="text"
          ...
          <div>
            <label className="flex items-center text-xs font-medium mb-1 text-gray-700 dark:text-gray-300">
              <Stethoscope className="mr-1" size={14} /> Upload Certificate
            </label>
            <input
              type="file"
          ...
          >
            {loading ? <Loader2 className="animate-spin mx-auto" size={16} /> : "Sign Up as Doctor"}
          </motion.button>
        </form>
